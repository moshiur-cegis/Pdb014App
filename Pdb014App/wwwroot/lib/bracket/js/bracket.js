...
$(document).ready(function () {
    ...
    $('#btnLeftMenu').on('click', function () {
        //console.log('btnLeftMenu > ' + $('body').hasClass('collapsed-menu'));
        ...
        if ($('body').hasClass('collapsed-menu')) {
            ...
            $('.jquery-accordion-menu .submenu').slideUp(250, function () {
                //if ($(this).closest('li').find('a.submenu-indicator-minus')) {
                //    $(this).closest('li').find('a.submenu-indicator-minus').removeClass('submenu-indicator-minus');
                //}
            });
            //$('.jquery-accordion-menu .submenu').slideUp();
    ...
    $(document).on('mouseover', function (e) {
        ...
        if ($('body').hasClass('collapsed-menu') && $('#btnLeftMenu').is(':visible')) {
            var menuText = $('.menu-item-label,.menu-item-arrow');
            if ($(e.target).closest('.br-sideleft').length) {
                $('body').addClass('expand-menu');

                //console.log('btnLeftMenu > ' + $('.show-sub + .br-menu-sub').length);
